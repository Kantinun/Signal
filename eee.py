...
if __name__ == "__main__":
    ...
    ui.btn_off.clicked.connect(lambda: myOsci.ch_display("off"))
    ui.btn_ch1.clicked.connect(lambda: myOsci.selectCh(0))
    ui.btn_ch2.clicked.connect(lambda: myOsci.selectCh(1))
    ui.btn_ch3.clicked.connect(lambda: myOsci.selectCh(2))
    ...
    ui.btn_ver_neScale.clicked.connect(lambda: myOsci.set_vol_scale("down"))
    ui.btn_ver_posScale.clicked.connect(lambda: myOsci.set_vol_scale("up"))
    ui.btn_hor_ne.clicked.connect(lambda: myOsci.setHorizontalPosition("down"))
