...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow, OS):
        self.myOsci = OS
        MainWindow.setObjectName("MainWindow")
        MainWindow.setEnabled(True)
        MainWindow.resize(938, 486)
    ...
    def get_image(self):
        image = self.myOsci.write_screen_capture("")
...
class Osci ():
    ...
    def set_vol_scale(self, ch, direction):
        volList = [str(0.001*self.probeRatio), str(0.002*self.probeRatio), str(0.005*self.probeRatio), str(0.01*self.probeRatio), str(0.02*self.probeRatio), str(0.05 *
                       self.probeRatio), str(0.1*self.probeRatio), str(0.2*self.probeRatio), str(0.5*self.probeRatio), str(1*self.probeRatio), str(2*self.probeRatio), str(5*self.probeRatio)]
        if self.indexVol < 0:
            self.indexVol = 0
...
if __name__ == "__main__":
    ...
    ui = Ui_MainWindow()
    ui.setupUi(MainWindow,Osci("169.254.1.140"))
